package io.github.mrergos.gymcrm.logging;
...
public class TransactionLoggingFilter extends OncePerRequestFilter {
    ...
    private String generateTransactionId(HttpServletRequest request) {
        ...
        return (incomingTransactionId != null && !incomingTransactionId.isBlank()) ? incomingTransactionId : UUID.randomUUID().toString();
    }
}
